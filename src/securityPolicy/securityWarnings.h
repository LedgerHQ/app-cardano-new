...
static inline const char* warning_bit_name(warning_bit_e bit) {
    static const char* const names[WARNING_BIT_COUNT] = {
        ...
        [WARNING_BIT_EMPTY_ANCHOR_URL] = "WARNING_BIT_EMPTY_ANCHOR_URL",
...
static inline void _trace_warning_bit(warning_bit_e bit) {
    switch (bit) {
        ...
        case WARNING_BIT_POOL_REGISTRATION_EMPTY_METADATA_URL:
            TRACE("Warning: POOL_REGISTRATION_EMPTY_METADATA_URL"); break;
        case WARNING_BIT_EMPTY_ANCHOR_URL:
            TRACE("Warning: EMPTY_ANCHOR_URL"); break;
