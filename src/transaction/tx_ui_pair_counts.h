...
#define UI_PAIRS_STAKING_INFO \
    1  // "Staking path", "Stake key hash", "Stake script hash", "Stake key pointer", or warning
#define UI_PAIRS_OUTPUT_DEVICE_OWNED \
    (UI_PAIRS_PAYMENT_INFO +         \
     UI_PAIRS_STAKING_INFO)  // key 1: Payment + Staking info (additional if device-owned)
...
#define UI_PAIRS_CERTIFICATE_STAKE_REGISTRATION_CONWAY \
    3  // key 4: "Certificate", credential, "Deposit"
#define UI_PAIRS_CERTIFICATE_STAKE_DEREGISTRATION_CONWAY \
    3  // key 4: "Certificate", credential, "Deposit"
...
#define UI_PAIRS_CERTIFICATE_ACCOUNT_REGISTRATION_DELEGATION_TO_STAKE_POOL \
    4  // key 4: "Certificate", credential, "Pool", "Deposit"
#define UI_PAIRS_CERTIFICATE_ACCOUNT_REGISTRATION_DELEGATION_TO_DREP \
    4  // key 4: "Certificate", credential, DRep, "Deposit"
#define UI_PAIRS_CERTIFICATE_ACCOUNT_REGISTRATION_DELEGATION_TO_STAKE_POOL_AND_DREP \
    5  // key 4: "Certificate", credential, "Pool", DRep, "Deposit"
#define UI_PAIRS_CERTIFICATE_AUTHORIZE_COMMITTEE_HOT \
    3  // key 4: "Certificate", cold credential, hot credential
#define UI_PAIRS_CERTIFICATE_RESIGN_COMMITTEE_COLD \
    2  // key 4: "Certificate", cold credential (+ anchor if included)
#define UI_PAIRS_CERTIFICATE_DREP_REGISTRATION \
    3  // key 4: "Certificate", DRep credential, "Deposit" (+ anchor if included)
#define UI_PAIRS_CERTIFICATE_DREP_DEREGISTRATION \
    3  // key 4: "Certificate", DRep credential, "Deposit"
#define UI_PAIRS_CERTIFICATE_DREP_UPDATE \
    2  // key 4: "Certificate", DRep credential (+ anchor if included)
#define UI_PAIRS_WITHDRAWAL_KEY_PATH \
    3  // key 5: "Withdrawal", "Withdrawal path", "Withdrawal" (reward addr)
...
#define UI_PAIRS_TOKEN \
    2  // Token pair: "Asset fingerprint", "Token/Mint amount" (used in outputs, mint, collateral
       // output)
...
#define UI_PAIRS_NETWORK_DETAILS \
    (UI_PAIRS_NETWORK_ID + UI_PAIRS_PROTOCOL_MAGIC)  // network details block
#define UI_PAIRS_COLLATERAL_OUTPUT_ADDRESS 1         // key 16: "Collateral address"
#define UI_PAIRS_COLLATERAL_OUTPUT_DEVICE_OWNED \
    (UI_PAIRS_PAYMENT_INFO +                    \
     UI_PAIRS_STAKING_INFO)  // key 16: Payment + Staking info (additional if device-owned)
