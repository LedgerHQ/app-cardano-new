 ...
 */
static inline __attribute__((always_inline)) typeof(G_context.tx_info.aux_data) *tx_aux_data_ctx(
    void) {
 ...
 */
static inline __attribute__((always_inline)) typeof(G_context.tx_info.body) *tx_body_ctx(void) {
 ...
 */
static inline __attribute__((always_inline)) typeof(G_context.tx_info.witness) *tx_witness_ctx(
    void) {
