...
// Generated by: tests/unit/generators/test_runner_generators/native_script_deny_runner_generators.py
...
static void test_derive_native_script_hash_deny_0_native_script_pubkey_invalid_key_path(void **state) {
    (void) state;
    run_fixture(&NATIVE_SCRIPT_FIXTURES[0]);
}

static void test_derive_native_script_hash_deny_1_native_script_n_of_k_invalid_required_count_higher_than_number_of_scripts(void **state) {
    (void) state;
    run_fixture(&NATIVE_SCRIPT_FIXTURES[1]);
}

static void test_derive_native_script_hash_deny_2_native_script_pubkey_device_owned_path_invalid_non_hardened_account(void **state) {
    (void) state;
    run_fixture(&NATIVE_SCRIPT_FIXTURES[2]);
}

static void test_derive_native_script_hash_deny_3_native_script_n_of_k_required_count_equals_zero_with_subscripts(void **state) {
    (void) state;
...
int main(void) {
    const struct CMUnitTest tests[] = {
        cmocka_unit_test(test_derive_native_script_hash_deny_0_native_script_pubkey_invalid_key_path),
        cmocka_unit_test(test_derive_native_script_hash_deny_1_native_script_n_of_k_invalid_required_count_higher_than_number_of_scripts),
        cmocka_unit_test(test_derive_native_script_hash_deny_2_native_script_pubkey_device_owned_path_invalid_non_hardened_account),
        cmocka_unit_test(test_derive_native_script_hash_deny_3_native_script_n_of_k_required_count_equals_zero_with_subscripts),
    };
