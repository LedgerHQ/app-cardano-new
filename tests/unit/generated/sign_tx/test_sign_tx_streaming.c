...
static void test_sign_tx_streaming_many_required_signers_expert_off(void **state) {
    (void) state;
    run_fixture_with_expert_mode(&FIXTURE_STREAMING_SIGN_TX_STREAMING_MANY_REQUIRED_SIGNERS, false);
}
...
static void test_sign_tx_streaming_many_required_signers_expert_on(void **state) {
    (void) state;
    run_fixture_with_expert_mode(&FIXTURE_STREAMING_SIGN_TX_STREAMING_MANY_REQUIRED_SIGNERS, true);
}
...
static void test_sign_tx_streaming_many_outputs_expert_on(void **state) {
    (void) state;
    run_fixture_with_expert_mode(&FIXTURE_STREAMING_SIGN_TX_STREAMING_MANY_OUTPUTS, true);
}

static void test_sign_tx_streaming_many_outputs_reject_tx_expert_on(void **state) {
    (void) state;
    run_fixture_reject_tx_with_expert_mode(&FIXTURE_STREAMING_SIGN_TX_STREAMING_MANY_OUTPUTS, true);
}
...
int main(void) {
    const struct CMUnitTest tests[] = {
        cmocka_unit_test(test_sign_tx_streaming_many_required_signers_expert_off),
        ...
        cmocka_unit_test(test_sign_tx_streaming_many_outputs_reject_tx_expert_on),
        cmocka_unit_test(test_sign_tx_blind_signing_prompt_many_outputs_expert_off),
        cmocka_unit_test(test_sign_tx_blind_signing_prompt_many_outputs_reject_tx_expert_off),
