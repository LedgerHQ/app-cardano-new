...
static const uint8_t FIXTURE_ALLEGRA_SIGN_TX_WITH_NO_TTL_AND_NO_VALIDITY_INTERVAL_START_WITNESS_0_EXPECTED_SIGNATURE[] = {
    0x4F, 0x6E, 0x3A, 0x61, 0xB4, 0x89, 0x21, 0xFA, 0x0C, 0x3F, 0x67, 0x85, 0x6F, 0xC9, 0x55, 0xE7,
    0x54, 0xD1, 0x6D, 0x21, 0x0F, 0x07, 0x25, 0xFF, 0x31, 0xD9, 0x59, 0xC5, 0x3F, 0x83, 0x0D, 0xDE,
    0xF3, 0x54, 0x66, 0x30, 0x40, 0xBC, 0x0B, 0xC4, 0x30, 0x61, 0x27, 0xC3, 0x54, 0x9F, 0x0C, 0x53,
    0x39, 0xCC, 0x5A, 0x60, 0x45, 0x12, 0x09, 0x0A, 0x4F, 0xE2, 0x6E, 0xBA, 0xDC, 0x80, 0x55, 0x0F,
};

static const witness_payload_t FIXTURE_ALLEGRA_SIGN_TX_WITH_NO_TTL_AND_NO_VALIDITY_INTERVAL_START_WITNESS_PAYLOADS[] = {
    { .payload = FIXTURE_ALLEGRA_SIGN_TX_WITH_NO_TTL_AND_NO_VALIDITY_INTERVAL_START_WITNESS_0_PAYLOAD, .payload_len = sizeof(FIXTURE_ALLEGRA_SIGN_TX_WITH_NO_TTL_AND_NO_VALIDITY_INTERVAL_START_WITNESS_0_PAYLOAD), .expected_warning_bits = 0, .expected_signature = FIXTURE_ALLEGRA_SIGN_TX_WITH_NO_TTL_AND_NO_VALIDITY_INTERVAL_START_WITNESS_0_EXPECTED_SIGNATURE },
};
...
static const uint8_t FIXTURE_ALLEGRA_SIGN_TX_WITH_NO_TTL_BUT_WITH_VALIDITY_INTERVAL_START_WITNESS_0_EXPECTED_SIGNATURE[] = {
    0xE2, 0x45, 0xB8, 0x99, 0x38, 0xAD, 0x18, 0x23, 0x61, 0xD6, 0x96, 0xDA, 0xFB, 0x06, 0x44, 0xB6,
    0xB9, 0x3B, 0xCF, 0xA3, 0xE6, 0x31, 0x71, 0x6A, 0xFB, 0x5F, 0x73, 0xB6, 0xB6, 0xD6, 0x85, 0x2C,
    0x93, 0x13, 0xD7, 0xFD, 0x34, 0xA4, 0xA4, 0x04, 0xE4, 0xB3, 0x45, 0xB6, 0x4D, 0x9B, 0x29, 0xDD,
    0xEF, 0x40, 0x61, 0x97, 0x91, 0x11, 0x06, 0x59, 0x30, 0x00, 0xCD, 0x2F, 0xD1, 0x8B, 0x90, 0x0F,
};

static const witness_payload_t FIXTURE_ALLEGRA_SIGN_TX_WITH_NO_TTL_BUT_WITH_VALIDITY_INTERVAL_START_WITNESS_PAYLOADS[] = {
    { .payload = FIXTURE_ALLEGRA_SIGN_TX_WITH_NO_TTL_BUT_WITH_VALIDITY_INTERVAL_START_WITNESS_0_PAYLOAD, .payload_len = sizeof(FIXTURE_ALLEGRA_SIGN_TX_WITH_NO_TTL_BUT_WITH_VALIDITY_INTERVAL_START_WITNESS_0_PAYLOAD), .expected_warning_bits = 0, .expected_signature = FIXTURE_ALLEGRA_SIGN_TX_WITH_NO_TTL_BUT_WITH_VALIDITY_INTERVAL_START_WITNESS_0_EXPECTED_SIGNATURE },
};
