...
static const witness_payload_t FIXTURE_CONWAY_WITHOUT_CERTIFICATES_SIGN_TX_WITH_TREASURY_WITNESS_PAYLOADS[] = {
    { .payload = FIXTURE_CONWAY_WITHOUT_CERTIFICATES_SIGN_TX_WITH_TREASURY_WITNESS_0_PAYLOAD, .payload_len = sizeof(FIXTURE_CONWAY_WITHOUT_CERTIFICATES_SIGN_TX_WITH_TREASURY_WITNESS_0_PAYLOAD), .expected_warning_bits = 0, .expected_signature = FIXTURE_CONWAY_WITHOUT_CERTIFICATES_SIGN_TX_WITH_TREASURY_WITNESS_0_EXPECTED_SIGNATURE },
};
...
static const witness_payload_t FIXTURE_CONWAY_WITHOUT_CERTIFICATES_SIGN_TX_WITH_DONATION_WITNESS_PAYLOADS[] = {
    { .payload = FIXTURE_CONWAY_WITHOUT_CERTIFICATES_SIGN_TX_WITH_DONATION_WITNESS_0_PAYLOAD, .payload_len = sizeof(FIXTURE_CONWAY_WITHOUT_CERTIFICATES_SIGN_TX_WITH_DONATION_WITNESS_0_PAYLOAD), .expected_warning_bits = 0, .expected_signature = FIXTURE_CONWAY_WITHOUT_CERTIFICATES_SIGN_TX_WITH_DONATION_WITNESS_0_EXPECTED_SIGNATURE },
};
