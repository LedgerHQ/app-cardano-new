...
static const witness_payload_t FIXTURE_BYRON_SIGN_TX_WITH_DEVICE_OWNED_BYRON_MAINNET_OUTPUT_WITNESS_PAYLOADS[] = {
    { .payload = FIXTURE_BYRON_SIGN_TX_WITH_DEVICE_OWNED_BYRON_MAINNET_OUTPUT_WITNESS_0_PAYLOAD, .payload_len = sizeof(FIXTURE_BYRON_SIGN_TX_WITH_DEVICE_OWNED_BYRON_MAINNET_OUTPUT_WITNESS_0_PAYLOAD), .expected_signature = FIXTURE_BYRON_SIGN_TX_WITH_DEVICE_OWNED_BYRON_MAINNET_OUTPUT_WITNESS_0_EXPECTED_SIGNATURE },
};
