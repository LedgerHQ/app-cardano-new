...
static const uint8_t FIXTURE_BYRON_SIGN_TX_WITH_THIRDPARTY_BYRON_MAINNET_OUTPUT_WITNESS_0_EXPECTED_SIGNATURE[] = {
    0x9C, 0x12, 0xB6, 0x78, 0xA0, 0x47, 0xBF, 0x31, 0x48, 0xE8, 0x67, 0xD9, 0x69, 0xFB, 0xA4, 0xF9,
    0x29, 0x50, 0x42, 0xC4, 0xFF, 0xF8, 0x41, 0x07, 0x82, 0x42, 0x5A, 0x35, 0x68, 0x20, 0xC7, 0x9E,
    0x75, 0x49, 0xDE, 0x79, 0x8F, 0x93, 0x04, 0x80, 0xBA, 0x83, 0x61, 0x5A, 0x5E, 0x2A, 0x19, 0x38,
    0x9C, 0x79, 0x5A, 0x32, 0x81, 0xA5, 0x90, 0x77, 0xB7, 0xD3, 0x7C, 0xD5, 0xA0, 0x71, 0xA6, 0x06,
};

static const witness_payload_t FIXTURE_BYRON_SIGN_TX_WITH_THIRDPARTY_BYRON_MAINNET_OUTPUT_WITNESS_PAYLOADS[] = {
    { .payload = FIXTURE_BYRON_SIGN_TX_WITH_THIRDPARTY_BYRON_MAINNET_OUTPUT_WITNESS_0_PAYLOAD, .payload_len = sizeof(FIXTURE_BYRON_SIGN_TX_WITH_THIRDPARTY_BYRON_MAINNET_OUTPUT_WITNESS_0_PAYLOAD), .expected_warning_bits = 0, .expected_signature = FIXTURE_BYRON_SIGN_TX_WITH_THIRDPARTY_BYRON_MAINNET_OUTPUT_WITNESS_0_EXPECTED_SIGNATURE },
};
...
static const uint8_t FIXTURE_BYRON_SIGN_TX_WITH_THIRDPARTY_BYRON_DAEDALUS_MAINNET_OUTPUT_RAW_TX[] = {
    ...
    0x1A, 0x19, 0x98, 0x34, 0x65, 0x00, 0x00, 0x00, 0x00, 0x00, 0x2D, 0xD2, 0xE8, 0x00, 0x01, 0x01,
...
static const uint8_t FIXTURE_BYRON_SIGN_TX_WITH_THIRDPARTY_BYRON_DAEDALUS_MAINNET_OUTPUT_WITNESS_0_EXPECTED_SIGNATURE[] = {
    0xFD, 0xCA, 0x79, 0x69, 0xA3, 0xE8, 0xBC, 0x09, 0x1C, 0x9E, 0xE3, 0x2C, 0x04, 0x73, 0x2F, 0x79,
    0xBB, 0x7C, 0x00, 0x91, 0xF1, 0x79, 0x6F, 0xD2, 0xC0, 0xE1, 0xDE, 0x8A, 0xA8, 0x54, 0x7A, 0x00,
    0x45, 0x7D, 0x50, 0xD0, 0x57, 0x6F, 0x4D, 0xD4, 0x21, 0xBA, 0xF7, 0x54, 0x49, 0x9C, 0xF0, 0xE7,
    0x75, 0x84, 0xE8, 0x48, 0xE3, 0x54, 0x7A, 0xDD, 0xD5, 0xD5, 0xB7, 0x16, 0x75, 0x97, 0xA3, 0x07,
};

static const witness_payload_t FIXTURE_BYRON_SIGN_TX_WITH_THIRDPARTY_BYRON_DAEDALUS_MAINNET_OUTPUT_WITNESS_PAYLOADS[] = {
    { .payload = FIXTURE_BYRON_SIGN_TX_WITH_THIRDPARTY_BYRON_DAEDALUS_MAINNET_OUTPUT_WITNESS_0_PAYLOAD, .payload_len = sizeof(FIXTURE_BYRON_SIGN_TX_WITH_THIRDPARTY_BYRON_DAEDALUS_MAINNET_OUTPUT_WITNESS_0_PAYLOAD), .expected_warning_bits = 0, .expected_signature = FIXTURE_BYRON_SIGN_TX_WITH_THIRDPARTY_BYRON_DAEDALUS_MAINNET_OUTPUT_WITNESS_0_EXPECTED_SIGNATURE },
};
...
static const uint8_t FIXTURE_BYRON_SIGN_TX_WITH_THIRDPARTY_BYRON_TESTNET_OUTPUT_WITNESS_0_EXPECTED_SIGNATURE[] = {
    0x22, 0x4D, 0x10, 0x31, 0x85, 0xF4, 0x70, 0x9F, 0x7B, 0x74, 0x93, 0x39, 0xFF, 0x7B, 0xA4, 0x32,
    0xD5, 0x0C, 0xA5, 0xCB, 0x74, 0x26, 0x78, 0x84, 0x7F, 0x5E, 0x57, 0x48, 0x58, 0xCF, 0x7D, 0xDA,
    0x7E, 0xD4, 0x02, 0x39, 0x9A, 0x9D, 0xDB, 0xA8, 0x1E, 0xCD, 0x73, 0x1B, 0x6F, 0x93, 0x9B, 0xA0,
    0x7A, 0x24, 0x7C, 0xD5, 0x70, 0xDC, 0xD5, 0x43, 0xF8, 0x3A, 0x9A, 0xEA, 0xDC, 0x4F, 0x96, 0x03,
};

static const witness_payload_t FIXTURE_BYRON_SIGN_TX_WITH_THIRDPARTY_BYRON_TESTNET_OUTPUT_WITNESS_PAYLOADS[] = {
    { .payload = FIXTURE_BYRON_SIGN_TX_WITH_THIRDPARTY_BYRON_TESTNET_OUTPUT_WITNESS_0_PAYLOAD, .payload_len = sizeof(FIXTURE_BYRON_SIGN_TX_WITH_THIRDPARTY_BYRON_TESTNET_OUTPUT_WITNESS_0_PAYLOAD), .expected_warning_bits = 0, .expected_signature = FIXTURE_BYRON_SIGN_TX_WITH_THIRDPARTY_BYRON_TESTNET_OUTPUT_WITNESS_0_EXPECTED_SIGNATURE },
};
...
static const uint8_t FIXTURE_BYRON_SIGN_TX_WITH_DEVICE_OWNED_BYRON_MAINNET_OUTPUT_WITNESS_0_PAYLOAD[] = {
    0x05, 0x80, 0x00, 0x00, 0x2C, 0x80, 0x00, 0x07, 0x17, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00,
};

static const uint8_t FIXTURE_BYRON_SIGN_TX_WITH_DEVICE_OWNED_BYRON_MAINNET_OUTPUT_WITNESS_0_EXPECTED_SIGNATURE[] = {
    0x6C, 0x23, 0x09, 0x01, 0xBE, 0x0E, 0x53, 0x63, 0x61, 0xE4, 0xA7, 0x8A, 0x71, 0xAE, 0x02, 0x3F,
    0x12, 0x24, 0x4F, 0xF5, 0x14, 0x09, 0x9A, 0x00, 0x70, 0x6F, 0x19, 0xD1, 0xE4, 0x78, 0x2A, 0xB0,
    0xE0, 0xED, 0xB0, 0x02, 0x72, 0x0C, 0xE4, 0x58, 0x72, 0x54, 0xAC, 0x8C, 0x9F, 0x3E, 0x19, 0x45,
    0xE7, 0xF7, 0x33, 0x7C, 0x45, 0x73, 0x49, 0xD4, 0x00, 0xEF, 0x00, 0xFE, 0x1C, 0x13, 0x97, 0x01,
};

static const witness_payload_t FIXTURE_BYRON_SIGN_TX_WITH_DEVICE_OWNED_BYRON_MAINNET_OUTPUT_WITNESS_PAYLOADS[] = {
    { .payload = FIXTURE_BYRON_SIGN_TX_WITH_DEVICE_OWNED_BYRON_MAINNET_OUTPUT_WITNESS_0_PAYLOAD, .payload_len = sizeof(FIXTURE_BYRON_SIGN_TX_WITH_DEVICE_OWNED_BYRON_MAINNET_OUTPUT_WITNESS_0_PAYLOAD), .expected_warning_bits = 0, .expected_signature = FIXTURE_BYRON_SIGN_TX_WITH_DEVICE_OWNED_BYRON_MAINNET_OUTPUT_WITNESS_0_EXPECTED_SIGNATURE },
};
...
static const tx_fixture_t FIXTURE_BYRON_SIGN_TX_WITH_DEVICE_OWNED_BYRON_MAINNET_OUTPUT = {
    ...
    .tx_body_cbor_hex = "a400818258201af8fa0b754ff99253d983894e63a2b09cbb56c833ba18c3384210163f63dcfc00018182582b82d818582183581c43c3a6570ffd317743bf828bc0dd92ebe2b8e8feaecf130e39d6ca84a0001afd2374db1a002dd2e802182a030a",
    ...
    .num_outputs = 1,
    .num_witnesses = 1,
    .witness_payloads = FIXTURE_BYRON_SIGN_TX_WITH_DEVICE_OWNED_BYRON_MAINNET_OUTPUT_WITNESS_PAYLOADS,
    .witness_payload_count = 1,
    .num_certificates = 0,
    .num_withdrawals = 0,
    .num_mint_asset_groups = 0,
