...
ValidNativeScriptTestCases = [
    ...
    ValidNativeScriptTestCase(
        "PUBKEY_third_party_script_hash_displayed_as_policy_id",
        NativeScript(
            NativeScriptType.PUBKEY_THIRD_PARTY,
            NativeScriptParamsPubkey(
                "3a55d9f68255dfbefa1efd711f82d005fae1be2e145d616c90cf0fa9"
    ...
    ValidNativeScriptTestCase(
        "ALL_script_no_subscripts",
        NativeScript(NativeScriptType.ALL, NativeScriptParamsScripts()),
    ...
    ValidNativeScriptTestCase(
        "ANY_script_no_subscripts",
        NativeScript(NativeScriptType.ANY, NativeScriptParamsScripts()),
    ...
    ValidNativeScriptTestCase(
        "N_OF_K_script_no_subscripts",
        NativeScript(NativeScriptType.N_OF_K, NativeScriptParamsNofK(0)),
        SignedData("3530cc9ae7f2895111a99b7a02184dd7c0cea7424f1632d73951b1d7"),
    ),
    ValidNativeScriptTestCase(
        "INVALID_BEFORE_script",
        NativeScript(NativeScriptType.INVALID_BEFORE, NativeScriptParamsInvalid(42)),
        SignedData("2a25e608a683057e32ea38b50ce8875d5b34496b393da8d25d314c4e"),
    ),
    ValidNativeScriptTestCase(
        "INVALID_BEFORE_script_slot_is_a_big_number",
        NativeScript(
    ...
    ValidNativeScriptTestCase(
        "INVALID_HEREAFTER_script",
        NativeScript(NativeScriptType.INVALID_HEREAFTER, NativeScriptParamsInvalid(42)),
        SignedData("1620dc65993296335183f23ff2f7747268168fabbeecbf24c8a20194"),
    ),
    ValidNativeScriptTestCase(
        "INVALID_HEREAFTER_script_slot_is_a_big_number",
        NativeScript(
...
InvalidScriptTestCases = [
    ...
    ValidNativeScriptTestCase(
        "N_OF_K invalid required count higher than number of scripts",
        NativeScript(NativeScriptType.N_OF_K, NativeScriptParamsNofK(1)),
