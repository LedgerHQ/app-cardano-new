...
transactionInitRejectTestCases: List[SignTxTestCase] = [
    SignTxTestCase("Sign_tx_Nonmainnet_protocol_magic",
     ...
     SignTxTestCase("Sign_tx_Invalid_network_id",
    ...
    SignTxTestCase("Sign_tx_Pool_registration_operator_too_few_certificates",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_registration_owner_too_few_certificates",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_registration_operator_too_many_certificates",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_registration_owner_too_many_certificates",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_registration_operator_too_many_withdrawals",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_registration_owner_too_many_withdrawals",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_registration_operator_mint_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_registration_owner_mint_included",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    # collateral inputs
    SignTxTestCase("Sign_tx_Ordinary_tx_collateral_inputs_included",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Multisig_tx_collateral_inputs_included",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_registration_operator_collateral_inputs_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_registration_owner_collateral_inputs_included",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    # required signers
    SignTxTestCase("Sign_tx_Pool_registration_operator_required_signers_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_registration_owner_required_signers_included",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
    ...
    SignTxTestCase("Sign_tx_Ordinary_tx_collateral_output_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Multisig_tx_collateral_output_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_registration_operator_collateral_output_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_registration_owner_collateral_output_included",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
    ...
    SignTxTestCase("Sign_tx_Ordinary_tx_total_collateral_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Multisig_tx_total_collateral_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_registration_operator_total_collateral_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_registration_owner_total_collateral_included",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
    ...
    SignTxTestCase("Sign_tx_Ordinary_tx_reference_inputs_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Multisig_tx_reference_inputs_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_registration_operator_reference_inputs_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_registration_owner_reference_inputs_included",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
...
addressParamsRejectTestCases: List[SignTxTestCase] = [
    SignTxTestCase("Sign_tx_Reward_address_key",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Reward_address_script",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_No_spending_path_Ordinary_Tx_1",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_No_spending_path_Ordinary_Tx_2",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_operator_spending_choice_not_path",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Multisig_unconditionally",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["internalBaseWithStakingPath"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_owner_unconditionally",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["internalBaseWithStakingPath"]],
                               42,
...
certificateRejectTestCases: List[SignTxTestCase] = [
    SignTxTestCase("Sign_tx_Pool_registration_in_Ordinary_Tx",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_registration_in_Multisig_Tx",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_registration_in_Plutus_Tx",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
...
certificateStakingRejectTestCases: List[SignTxTestCase] = [
    SignTxTestCase("Sign_tx_Script_hash_in_Ordinary_Tx",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [TxOutputAlonzo(destinations["paymentScriptHash"], 10)],
                               42,
...
certificateStakePoolRetirementRejectTestCases: List[SignTxTestCase] = [
    SignTxTestCase("Sign_tx_Nonpool_cold_key_in_Ordinary_Tx",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
...
withdrawalRejectTestCases: List[SignTxTestCase] = [
    SignTxTestCase("Sign_tx_Script_hash_as_stake_credential_in_Ordinary_Tx",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Nonstaking_path_as_stake_credential_in_Ordinary_Tx",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Staking_path_as_stake_credential_in_Multisig_Tx",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
...
singleAccountRejectTestCases: List[SignTxTestCase] = [
    SignTxTestCase("Sign_tx_Change_output_and_withdrawal_account_mismatch",
                   Transaction(Mainnet,
                            [inputs["utxoShelley"]],
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Stake_deregistration_certificate_and_withdrawal_account_mismatch",
                   Transaction(Mainnet,
                            [inputs["utxoShelley"]],
                            [TxOutputBabbage(destinations["multiassetThirdParty"], 1)],
                            42,
...
invalidCertificates: List[SignTxTestCase] = [
   SignTxTestCase("Sign_tx_pool_registration_with_no_owners",
                   Transaction(Mainnet,
                               [inputs["utxoNoPath"]],
                               [outputs["externalShelleyBaseKeyhashKeyhash"]],
                               42,
...
stakePoolRegistrationPoolIdRejectTestCases: List[SignTxTestCase] = [
    SignTxTestCase("Sign_tx_Path_sent_in_for_Pool_Registration_Owner_Tx",
                   Transaction(Mainnet,
                               [inputs["utxoNoPath"]],
                               [outputs["externalShelleyBaseKeyhashKeyhash"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Hash_sent_in_for_Pool_Registration_Operator_Tx",
                   Transaction(Mainnet,
                               [inputs["utxoNoPath"]],
                               [outputs["externalShelleyBaseKeyhashKeyhash"]],
                               42,
...
stakePoolRegistrationOwnerRejectTestCases: List[SignTxTestCase] = [
    SignTxTestCase("Sign_tx_Nonstaking_path_for_Pool_Registration_Owner_Tx",
                   Transaction(Mainnet,
                               [inputs["utxoNoPath"]],
                               [outputs["externalShelleyBaseKeyhashKeyhash"]],
                               42,
...
outputRejectTestCases: List[SignTxTestCase] = [
    SignTxTestCase("Sign_tx_Pool_operator_datum_hash",
                   Transaction(Mainnet,
                               [inputs["utxoNoPath"]],
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_operator_datum_inline",
                   Transaction(Mainnet,
                               [inputs["utxoNoPath"]],
                               [outputs["inlineDatum480Map"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_operator_reference_script",
                   Transaction(Mainnet,
                               [inputs["utxoNoPath"]],
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_owner_datum_hash",
                   Transaction(Mainnet,
                               [inputs["utxoNoPath"]],
                               [outputs["datumHashExternalMap"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_owner_datum_inline",
                   Transaction(Mainnet,
                               [inputs["utxoNoPath"]],
                               [outputs["inlineDatum480Map"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Sign_tx_Pool_owner_reference_script",
                   Transaction(Mainnet,
                               [inputs["utxoNoPath"]],
                               [outputs["refScriptExternalMap"]],
                               42,
